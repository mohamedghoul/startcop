...
class RAGPipeline:
	...
	"""
	def __init__(self, db_client=None, chroma_host="chroma", chroma_port=8000, collection_name="regulations"):
		"""
	...
	def chunk_and_ingest_markdown(self, markdown_text: str, source_file: str, is_test: bool = False) -> int:
		"""
	...
	def run(self, query: str, top_k: int = 5, with_scorecard: bool = False) -> Dict[str, Any]:
		"""
		...
		if with_scorecard:
			...
			scorecard = self.scorecard.score(explanation)  # Assuming score method exists
